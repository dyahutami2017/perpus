...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="landing-page/images/favicon.png" type="image/png">
  ...
  <![endif]-->
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    <li class="nav-item">
                                        <a class="page-scroll" href= "">Cari Buku</a>
                                    </li>
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            <a class="dropdown-item text-dark text-center" href="#">Fiksi</a>
                                            <a class="dropdown-item text-dark text-center" href="#">Non Fiksi</a>
                                            <a class="dropdown-item text-dark text-center" href="#">Komik</a>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-hero-image text-center wow fadeIn" data-wow-duration="1.3s"
                            data-wow-delay="1.4s">
                            <img src="landing-page/images/header-hero.png" alt="hero">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <img src="landing-page/images/about1.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
        <div class="about-shape-1">
            <img src="landing-page/images/about-shape-1.svg" alt="shape">
        </div>
    </section>
    ...
    <section class="about-area pt-70">
        <div class="about-shape-2">
            <img src="landing-page/images/about-shape-2.svg" alt="shape">
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-first">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <img src="landing-page/images/about2.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <img src="landing-page/images/about3.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="video-content mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img class="dots" src="landing-page/images/dots.svg" alt="dots">
                        <div class="video-wrapper">
                            <div class="video-image">
                                <img src="landing-page/images/video.png" alt="video">
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="team-image">
                            <img src="landing-page/images/team-1.png" alt="Team">
                            <div class="social">
                                <ul>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="team-image">
                            <img src="landing-page/images/team-2.png" alt="Team">
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="#"><i class="lni-twitter-filled"></i></a></li>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="team-image">
                            <img src="landing-page/images/team-3.png" alt="Team">
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="#"><i class="lni-twitter-filled"></i></a></li>
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="landing-page/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="landing-page/images/author-1.png" alt="author">
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="landing-page/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="landing-page/images/author-2.png" alt="author">
                            </div>
                            <div class="author-content media-body">
                ...
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="landing-page/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="landing-page/images/author-3.png" alt="author">
                            </div>
                            <div class="author-content media-body">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="blog-image">
                            <img src="landing-page/images/blog-1.jpg" alt="blog">
                        </div>
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="blog-image">
                            <img src="landing-page/images/blog-2.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul class="meta">
                                <li>Posted By: <a href="#">Admin</a></li>
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="blog-image">
                            <img src="landing-page/images/blog-3.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul class="meta">
                                <li>Posted By: <a href="#">Admin</a></li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="footer-about mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <a class="logo" href="#">
                                <img src="landing-page/images/logo.svg" alt="logo">
                            </a>
