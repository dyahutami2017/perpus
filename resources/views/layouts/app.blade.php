...
<body>
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo strong" href="index.html" style="color: #2d2d2d; font-size:24px">
          Perpus Stewa
        </a>
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            ...
            <a href="https://gilacoding.com/" target="_blank">SMK N 2 Pengasih</a>. All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
