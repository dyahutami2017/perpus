                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('kategori') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="kategori" required="">
                                ...
                                <option value="1" {{$data->kategori_id === 1 ? "selected" :""}}>Komik</option>
                                <option value="2" {{$data->kategori_id === 2 ? "selected" :""}}>Non Fiksi</option>
                                <option value="3" {{$data->kategori_id === 3 ? "selected" :""}}>Fiksi dan Sastra</option>
