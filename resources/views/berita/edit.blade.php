    ...
    <div class="col-md-6">
        ...
        <form action="{{ url('/berita/update/') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="ket_berita" id="ket_berita" class="form-control" rows="10">{{$b->keterangan}}</textarea>
            </div>
            <div class="form-group">
                <div class="custom-file">
                    <label class="custom-file-label" id="fileLabel" for="file">{{$b->file}}</label>
